    ...
    <nav className="flex justify-between items-center py-3 px-4 shadow-xl bg-[#084255] ">
        ...
        <NavLink to="/dashboard">
          <div className="flex">
            <img
              alt="fastFIT"
              src={fastfit}
              className="h-[50px] w-[50px] pr-0"
            />
            <h2 className="text-4xl italic text-[#fff2f1] font-bold">
      ...
      <div className={showLinks}>
        <NavLink to="/workout/plan">
          <h2 className="text-l text-[#fff2f1] shadow font-bold">
            Workout Plan
          </h2>
        </NavLink>
        <NavLink to="/meals/user">
          <h2 className="text-l text-[#fff2f1] shadow font-bold">Meal Plans</h2>
        </NavLink>
        <NavLink to="/journals">
          <h2 className="text-l text-[#fff2f1] shadow font-bold">
            Your Journal
